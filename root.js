...
// (async () => {
//   let excelsData = await ExcelsUtils.readExcel("input/fdct.xlsx")
...
<string name="address2">地點</string>
...
<string name="already_add_job">已成功新建工作</string>
...
<string name="action_complete_work">完成工作</string>

<string name="executor">執行人</string>
<string name="action_type">操作類型</string>
<string name="reset_job">重啟工作</string>
...
<string name="inspection_build_success">巡查建立成功</string>
...
<string name="inspection_business_object_attr">巡查對象屬性資料</string>
...
<string name="inspection_execute_scope">範圍內執行</string>
<string name="project_type">項目類型</string>
<string name="limit_lower">(至少%1$s個附件)</string>
...
<string name="job_level">優先程度</string>
...
<string name="device_code">設備前綴</string>
...
<string name="submit_success">建立成功</string>
<string name="submit_failure">建立失敗</string>
...
<string name="work_orgin">問題來源</string>
...
<string name="please_finish_time">請填寫解決時間</string>
...
<string name="login_shangshetong">商社通登入</string>
<string name="enter_app">進入APP</string>
<string name="ga_login">公務通登入</string>
...
<string name="confirm_initial">確認初復</string>
<string name="provide_time_estimated">提供預計完成時間</string>
...
<string name="unlink_case">個案取消關聯</string>
...
<string name="nfc_location">查看%1$d筆定位/NFC記錄</string>
<string name="ERROR_NOT_NFC">打卡失敗，無NFC標籤記錄</string>
<string name="Seq">流水號</string>
<string name="AREA_OBJECT_SEARCH">區域 - 對象區域</string>
<string name="BUSINESSOBJECT_SEARCH">對象</string>
...
<string name="error2">巡查時間未夠%1$s</string>
...
<string name="task_number">工作流水號：%1$d\n巡查流水號：%2$d</string>
<string name="error_10">本機有巡查中待完成的巡查，該巡查不可立即執行。</string>
<string name="error_11">建立巡查失敗，%1$s</string>
<string name="error_12">該對象無配置巡查模板</string>
<string name="error13">未選擇巡查對象</string>
<string name="error_14">當前巡查類型對應的對象編號不存在</string>
...
<string name="error_19">已超過執行計劃時間，不可執行</string>
<string name="error_20">當前定位不在地點範圍內</string>
<string name="not_job">暫無關聯工作</string>
<string name="with_add_job">因後台未設置工作資料而未能新增/關聯工作</string>
<string name="error15">事項未完成跟進，是否退出</string>
...
<string name="error20">當前巡查類型對應的對象編號不存在</string>
<string name="error21">獲取工作詳情失敗</string>
<string name="job_not_realate">項目為%1$s、工作狀態為%2$s且未關聯的工作</string>
...
<string name="error35">%1$s項目附件數量少於%2$s</string>
...
<string name="only_attachment">只看有附件</string>
